...
def create_test_and_train_csv(G_train, G_test, training_edges, test_edges):
    with open("training_edges.csv", "w+") as my_csv:
        ...
        csvWriter.writerow(['in_degree_u', 'in_degree_v', 'out_degree_u', 'out_degree_v', 'num_common_out', 'num_common_in', 'ratio_1', 'ratio_2', 'ratio_3', 'ratio_4', 'avg_ratings_into_v', 'avg_ratings_out_of_u', 'fairness_u', 'fairness_v', 'goodness_u', 'goodness_v','f_times_g', 'weight'])
        ...
        for edge in G_train.edges():
            ...
            f_times_g = fairness_u * goodness_v
            result_array = []
            result_array.extend((in_degree_u, in_degree_v, out_degree_u, out_degree_v, num_common_out, num_common_in, ratio_1, ratio_2, ratio_3, ratio_4, avg_ratings_into_v, avg_ratings_out_of_u, fairness_u, fairness_v, goodness_u, goodness_v,f_times_g, weight))
